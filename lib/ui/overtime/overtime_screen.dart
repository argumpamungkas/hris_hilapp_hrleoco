                                  ...
                                  BottomSheetHelper.showModalDetail(
                                    ...
                                    columnList: Column(
                                      ...
                                      children: [
                                        ...
                                        ItemDetailTransaction(title: "Plan Amount", value: formatIDR(int.parse(item.amount!)) ?? ""),
                                        Container(
                                        ...
                                        ItemDetailTransaction(title: "Amount", value: formatIDR(item.overtimeAmount! ?? 0)),
                                        ItemDetailTransaction(title: "Meal", value: formatIDR(int.parse(item.overtimeMeal!)) ?? '0'),
