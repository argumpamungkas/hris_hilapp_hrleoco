                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextFieldCustom(
                                    ...
                                    readOnly: true,
                                    isRequired: prov.permitTypeModel != null && prov.permitTypeModel?.attachment?.toUpperCase() == "YES"
                                        ? true
                                        : false,
                                    maxLine: 1,
                                  ...
                                  ElevatedButtonCustom(
                                    onPressed: () {
                                      if (prov.formKey.currentState!.validate()) {
                                        // Check attachment is required ?
                                        // if (prov.permitTypeModel == null && prov.permitTypeModel?.attachment?.toUpperCase() == "YES") {
                                        //   if (prov.attachment == null) {
                                        //     DialogHelper.showInfoDialog(
                                        //       context,
                                        //       title: "Attachment",
                                        //       message: "Attachment is Required. Please choose attachment",
                                        //       onPressed: () {
                                        //         Navigator.pop(context);
                                        //         return;
                                        //       },
