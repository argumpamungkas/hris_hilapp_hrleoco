...
//   const OvertimeNotificationWidget({super.key, required this.dataItem, required this.prov, required this.module, required this.dataNotif});
//
...
//                   if (item.start != null) {
//                     var dateFormatDefautlt = DateFormat("HH:mm:ss").parse(item.start!);
//                     start = formatTimeAttendance(dateFormatDefautlt);
//                   }
//
//                   if (item.end != null) {
//                     var dateFormatDefautlt = DateFormat("HH:mm:ss").parse(item.end!);
//                     end = formatTimeAttendance(dateFormatDefautlt);
//                   }
//
//                   if (item.transDate != null) {
//                     var dateFormatDefautlt = DateFormat("yyyy-MM-dd").parse(item.transDate!);
...
//                             ItemDataNotification(title: "Request Code", value: item.requestCode!),
//                             ItemDataNotification(title: "Document No", value: item.idmNo ?? "-"),
//                             ItemDataNotification(title: "Overtime Date", value: item.transDate != null ? transDate! : '-'),
//                             ItemDataNotification(title: "Start", value: item.start != null ? start! : "-"),
//                             ItemDataNotification(title: "End", value: item.end != null ? end! : "-"),
//                             ItemDataNotification(title: "Work Duration", value: item.duration ?? "-"),
//                             ItemDataNotification(title: "Break", value: item.resBreak ?? "-"),
//                             ItemDataNotification(title: "Meal", value: item.meal == "0" ? "No" : "Yes"),
//                             ItemDataNotification(title: "Plan Overtime", value: item.plan ?? "-"),
//                             ItemDataNotification(title: "Actual Overtime", value: item.actual ?? "-"),
...
//                                                     await prov.approved(dataNotif, item.id, module).then((value) {
//                                                       Navigator.pop(context);
...
//                                                     Navigator.pop(context);
//                                                     showLoadingDialog(context);
//                                                     await prov.disapproved(dataNotif, item.id, module).then((value) {
//                                                       Navigator.pop(context);
//                                                       if (value.theme == "success") {
//                                                         showLoadingDialog(context);
//                                                         notifC.fetchNotification();
...
//                                         Navigator.pop(context);
//                                         showLoadingDialog(context);
//                                         await prov.approvedAll(dataNotif: dataNotif, module: module).then((value) {
//                                           Navigator.pop(context);
//                                           if (value.theme == "success") {
//                                             showLoadingDialog(context);
//                                             notifC.fetchNotification();
...
//                                   descriptionConfirm: "Are you sure for disapprove all ?",
//                                   action: [
//                                     TextButton(onPressed: () => Navigator.pop(context), child: const Text("Cancel")),
//                                     TextButton(
//                                       onPressed: () async {
//                                         Navigator.pop(context);
//                                         showLoadingDialog(context);
//                                         await prov.disapprovedAll(dataNotif: dataNotif, module: module).then((value) {
//                                           Navigator.pop(context);
//                                           if (value.theme == "success") {
//                                             showLoadingDialog(context);
//                                             notifC.fetchNotification();
