...
class CareerEmployeeScreen extends StatelessWidget {
  const CareerEmployeeScreen({super.key});
                  ...
                  builder: (context, prov, provPref, _) {
                    ...
                    return RefreshIndicator(
                      ...
                      child: ListView.builder(
                        itemCount: prov.employeeResponseModel!.employeeCarrers.length,
                        itemBuilder: (context, index) {
                          final employee = prov.employeeResponseModel!.employeeCarrers[index];
                          return Card(
                            child: ExpansionTile(
